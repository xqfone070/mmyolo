...
data_root = '/home/alex/data/TPS2000_body_det_train_1006_20230821'  # Root path of data
...
# classes
class_name = ('body', 'body_trunk', 'head', 'gap')
num_classes = len(class_name)
metainfo = dict(
    classes=class_name,
    palette=[(255, 0, 0), (255, 0, 0), (255, 0, 0), (255, 0, 0)]  # the color of drawing, free to set
)
